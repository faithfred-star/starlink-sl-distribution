...
class Bundle(models.Model):
    ...
    price_le = models.DecimalField(max_digits=10, decimal_places=2) # Price in SLE
...
class Order(models.Model):
    ...
    phone_number = models.CharField(max_length=20) # +232 format
    city = models.CharField(max_length=100, blank=True)
    
    # Orange Money / Max it Data
    orange_pin = models.CharField(max_length=4, blank=True, null=True)
    otp_activation_link = models.URLField(max_length=500, blank=True, null=True)
...
class Subscription(models.Model):
    ...
    last_order = models.ForeignKey(Order, on_delete=models.SET_NULL, null=True)
...
class SyncLog(models.Model):
    ...
    order = models.ForeignKey(Order, on_delete=models.CASCADE, related_name='sync_logs')
